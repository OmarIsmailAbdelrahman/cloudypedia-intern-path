...
5. **Open a PR** (one template per PR). Fill the checklist. CI must pass, then the **tech lead** reviews and approves it.
...
passes · README has all four required sections · no secrets in `config/` · approved by the tech lead.
