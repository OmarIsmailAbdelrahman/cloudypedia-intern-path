...
5. **Open a PR** (one template per PR). Fill the checklist. CI must pass and a *different* intern must review.
...
passes · README has all four required sections · no secrets in `config/` · peer-reviewed.
