# Definition of done — hello-pipeline
- [x] Runs locally from a clean checkout with one command (`bash local/run_local.sh`).
- [x] Sample input AND output committed to `sample_data/`.
